...
import (
	...
	"github.com/hpb-project/go-hpb/hpbclient"
...
var (
	...
	nodeFlags = []cli.Flag{
		...
		utils.NoUSBFlag,
		utils.HpbhashCacheDirFlag,
		utils.HpbhashCachesInMemoryFlag,
		utils.HpbhashCachesOnDiskFlag,
		utils.HpbhashDatasetDirFlag,
		utils.HpbhashDatasetsInMemoryFlag,
		utils.HpbhashDatasetsOnDiskFlag,
...
func init() {
	...
	app.Copyright = "Copyright 2013-2017 The go-hpb Authors"
...
func startNode(ctx *cli.Context, stack *node.Node) {
	...
	go func() {
		...
		stateReader := hpbclient.NewClient(rpcClient)
